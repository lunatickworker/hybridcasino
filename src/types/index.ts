...
export interface Transaction {
  ...
  user_id: string;
  partner_id?: string;
  transaction_type: 'deposit' | 'withdrawal' | 'point_conversion' | 'admin_adjustment' | 'admin_deposit' | 'admin_withdrawal' | 'admin_deposit_initial' | 'admin_deposit_send' | 'admin_withdrawal_initial' | 'admin_withdrawal_send' | 'partner_deposit' | 'partner_withdrawal' | 'partner_online_deposit' | 'partner_online_withdrawal';
  amount: number;
