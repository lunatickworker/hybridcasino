            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="px-4 py-3 text-center text-white bg-slate-700/50 whitespace-nowrap">카지노루징%</th>
                  <th className="px-4 py-3 text-center text-white bg-slate-700/50 whitespace-nowrap">슬롯롤링%</th>
                  <th className="px-4 py-3 text-center text-white bg-slate-700/50 whitespace-nowrap">슬롯루징%</th>
