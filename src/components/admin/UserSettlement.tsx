            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  {/* 기본 정보 */}
                  <th className="px-4 py-3 text-left text-white sticky left-0 bg-slate-900 z-10 whitespace-nowrap">아이디</th>
                  ...
                  <th className="px-4 py-3 text-right text-white bg-emerald-950/60 whitespace-nowrap">롤링금</th>
                  <th className="px-4 py-3 text-right text-white bg-teal-950/60 whitespace-nowrap">낙첨금</th>
                </tr>
              </thead>
              <tbody>
